...
import { updateJobTitleDto } from './updateJobTitle_joblist.dto';
  ...
  export class CompanyjoblistController {
    ...
    addJoblist(@Body() addData: CreateJoblistDto) {
    ...
    getCompanyJoblistByID(@Param('joblistId', ParseIntPipe) jobId: number) {
    ...
    updateAllCompanyJoblist(
      ...
      return this.companyProfileService.updateAllJoblist(jobId, updateCompanyJoblist);
    }
   ...
   updateJobTitle(
    ...
    deleteCompanyProfile(@Param('jobId') jobId: number) {
